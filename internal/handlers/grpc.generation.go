...
var generationStatuses = map[dao.GenerationStatus]genaiv1.GenerationStatus{
	dao.GenerationStatusPending:   genaiv1.GenerationStatus_GENERATION_STATUS_PENDING,
	dao.GenerationStatusRunning:   genaiv1.GenerationStatus_GENERATION_STATUS_RUNNING,
	dao.GenerationStatusSucceeded: genaiv1.GenerationStatus_GENERATION_STATUS_SUCCEEDED,
	dao.GenerationStatusFailed:    genaiv1.GenerationStatus_GENERATION_STATUS_FAILED,
	dao.GenerationStatusAbandoned: genaiv1.GenerationStatus_GENERATION_STATUS_ABANDONED,
	dao.GenerationStatusCancelled: genaiv1.GenerationStatus_GENERATION_STATUS_CANCELLED,
}
...
func NewGrpcGeneration(generation *dao.Generation) *genaiv1.Generation {
	message := &genaiv1.Generation{
