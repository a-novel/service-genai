...
func TestGrpcUsageQuery(t *testing.T) {
	...
	testCases := []struct {
		...
		request *genaiv1.UsageQueryRequest
	...
	}{
		{
			...
			request: &genaiv1.UsageQueryRequest{OwnerId: testOwnerID, From: from, To: to},
		...
		},
		{
			...
			request: &genaiv1.UsageQueryRequest{OwnerId: "not-a-uuid", From: from, To: to},
		...
		},
		{
			...
			request: &genaiv1.UsageQueryRequest{OwnerId: testOwnerID, From: "yesterday", To: to},
		...
		},
		{
			...
			request: &genaiv1.UsageQueryRequest{OwnerId: testOwnerID, From: from, To: ""},
