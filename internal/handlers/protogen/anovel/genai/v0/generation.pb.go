...
// 	protoc        (unknown)
// source: anovel/genai/v0/generation.proto
...
func (x *Generation) Reset() {
	*x = Generation{}
	mi := &file_anovel_genai_v0_generation_proto_msgTypes[0]
...
var (
	file_anovel_genai_v0_generation_proto_rawDescOnce sync.Once
	file_anovel_genai_v0_generation_proto_rawDescData []byte
)

func file_anovel_genai_v0_generation_proto_rawDescGZIP() []byte {
	file_anovel_genai_v0_generation_proto_rawDescOnce.Do(func() {
		file_anovel_genai_v0_generation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_anovel_genai_v0_generation_proto_rawDesc), len(file_anovel_genai_v0_generation_proto_rawDesc)))
	})
...
func file_anovel_genai_v0_generation_proto_init() {
	if File_anovel_genai_v0_generation_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_anovel_genai_v0_generation_proto_goTypes,
		DependencyIndexes: file_anovel_genai_v0_generation_proto_depIdxs,
		EnumInfos:         file_anovel_genai_v0_generation_proto_enumTypes,
		MessageInfos:      file_anovel_genai_v0_generation_proto_msgTypes,
	}.Build()
	File_anovel_genai_v0_generation_proto = out.File
	file_anovel_genai_v0_generation_proto_goTypes = nil
	file_anovel_genai_v0_generation_proto_depIdxs = nil
}
