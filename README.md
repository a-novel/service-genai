...
services:
  postgres-genai:
    image: ghcr.io/a-novel/service-genai/database:v0.1.0
    networks: [api]
    environment:
  ...
  migrations-genai:
    image: ghcr.io/a-novel/service-genai/migrations:v0.1.0
    depends_on:
  ...
  service-genai:
    image: ghcr.io/a-novel/service-genai/grpc:v0.1.0
